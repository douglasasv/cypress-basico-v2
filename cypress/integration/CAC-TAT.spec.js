...
describe('Central de Atendimento ao Cliente TAT', function () {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function () {
        ...
        cy.get('#lastName').type('velho')
        cy.get('#email').type('douglas@teste.com.br')
        cy.get('#open-text-area').type(longText, { delay: 0 })
        cy.get('button[type="submit"]').click()


        //validação a classe success visível
    ...
    it('exibe mensagem de erro ao submeter o formulário com um email com formatação inválida', function () {
        ...
        cy.get('#firstName').type('douglas')
        cy.get('#lastName').type('velho')
        cy.get('#email').type('douglas@com,br')
    ...
    Cypress._.times(3, function () {
        ...
        it('Teste 3 vezes - campo telefone continua vazio quando preenchido com campo não numérico', function () {
    ...
    it('preenche os campos obrigatórios e envia o formulário Exercício 8', function () {
    ...
    it('preenche a area de texto usando o comando invoke', function () {
        ...
        const longoTexto = Cypress._.repeat('0123456789', 20)
        cy.get('#open-text-area')
            .invoke('val', longoTexto)
            .should('have.value', longoTexto)
    })
